...
If you're wondering what the name of this website means, there's a good chance you've never used Lisp. "Cons" is a fundamental Lisp data structure. You can think of it as a pair whose first element contains a value and whose second element contains a pointer to another cons.