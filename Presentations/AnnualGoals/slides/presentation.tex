...
\begin{document}
    ...
    \begin{frame}
      ...
      \end{itemize}
      \note<3->[item]{This makes it a great platform for a Sandbox:\\Lump all
        your software and its configuration in a container which you can
        reasonably expect to keep running.}
    \end{frame}
    ...
    \begin{frame}
      ...
      \begin{itemize}
      \item<2-> Linux: clearly the best choice for this \item<3-> Windows: surprisingly great
        \begin{itemize}
